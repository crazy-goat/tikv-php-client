...
/**
 * Generated from protobuf message <code>kvrpcpb.PrewriteResponse</code>
 */
class PrewriteResponse extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>uint64 min_commit_ts = 3;</code>
     */
     ...
     *
     * Generated from protobuf field <code>uint64 one_pc_commit_ts = 4;</code>
     */
    protected $one_pc_commit_ts = 0;
    /**
     ...
     *           commit cannot proceed. The client can then fallback to normal way to
     *           continue committing the transaction if prewrite are all finished.
     *     @type int|string $one_pc_commit_ts
     *           When the transaction is successfully committed with 1PC protocol, this field will be set to
     *           the commit ts of the transaction. Otherwise, if TiKV failed to commit it with 1PC or the
     *           transaction is not 1PC, the value will be 0.
     ...
     * @return int|string
     */
    public function getOnePcCommitTs()
    {
     ...
     * @return $this
     */
    public function setOnePcCommitTs($var)
    {
        GPBUtil::checkUint64($var);
        $this->one_pc_commit_ts = $var;
