# TiKV PHP Client - Alpine Edge + Pre-built gRPC Packages

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Create working TiKV RawKV client using Alpine Edge with pre-built php84-pecl-grpc packages (no compilation)

**Architecture:** 
- Use Alpine Edge with pre-built php84-pecl-grpc package (version 1.78.0)
- Zero compilation time - instant Docker builds
- Same PHP client code structure as before

**Tech Stack:**
- Alpine Edge (edge/main + edge/community repos)
- PHP 8.4 with php84-pecl-grpc
- Composer for dependencies
- TiKV v7.1.0 cluster

---

## Task 1: Create Optimized Dockerfile with Alpine Edge
...
# Install PHP 8.4 + pre-built grpc extension
...
## Task 2: Update composer.json for grpc/grpc
...
## Task 3: Create Docker Compose with TiKV Cluster
...
# Build and run PHP client (should be very fast!)
docker-compose up --build php-client
```

## Success Criteria

- [ ] `docker-compose up --build php-client` completes in under 30 seconds
- [ ] Example script outputs "All operations completed successfully!"
- [ ] Put/Get/Delete operations work correctly
- [ ] No C++ compilation during build
